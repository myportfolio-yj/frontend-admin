        ...
        <div class="col">
            <div class="card h-100">
                ...
                <div class="card-body">
                    ...
                    <p class="card-text">Este grafico nos sirve como reporte para identificar los usuarios registrados
                        por un
                        mes determinado.</p>
                    {!! $chart1->renderHtml() !!}
                </div>
        ...
        <div class="col">
            <div class="card h-100">
                ...
                <div class="card-body">
                    ...
                    <p class="card-text">Este grafico nos sirve como reporte para identificar las alergias registradas
                        por
